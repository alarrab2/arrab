...
---------- {Show Files} ----------- 
  ...
  Green = "\27[32m"
  print(Green.."\nFiles Now Started : \n "..reset)
  local files_arrab = database:smembers("files"..bot_id)
	for i,v in ipairs(files_arrab) do
  print(Blue..i..red..' - \27[10;33m'..v..',\27[m')
  end
  print(Green.."\nThes all Files.\n\n\n"..reset)
  io.popen("mkdir files_arrab")
----------- {end} ----------
...
local files_arrab = database:smembers("files"..bot_id)
local keko = io.popen('cd files_arrab && ls'):read("*all")
local files_arrab2 = ''
for i=1,#files_arrab do 
files_arrab2 = files_arrab2..'{'..files_arrab[i]..'}\n'
end
...
io.popen("rm -fr files_arrab/"..name_t[2]..'.lua')
database:srem("files"..bot_id,name_t[2]..'.lua')
...
local arrabe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. arrabe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'files_arrab/'..name_t[2]..'.lua' .. '"'
io.popen(curl)
end
end
...
local photo_keko = download_to_file('https://api.telegram.org/file/bot'..token..'/'..keko6.result.file_path, 'files_arrab/'..data.message_.content_.document_.file_name_)
...
local files_arrab = database:smembers("files"..bot_id)
for i=1,#files_arrab do 
local arrabee = dofile("files_arrab/"..files_arrab[i])
local kt = arrabee.keko_arrab(data)
if kt == 'end' then 
return false 
end			
end
...
text = text.."|"..i.."| ~⪼ "..gpss[i].."\n ~⪼ "..(link or  "لا يوجد رابط").."\n"
 ...
 local f = io.open('arrab.txt', 'w')
 f:write(text)
 f:close()
 local arrabe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
 local curl = 'curl "' .. arrabe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'arrab.txt' .. '"'
 io.popen(curl)
 end
...
if database:get('bot:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, "`• تم قفل كل الوسائط لمدة` "..mutept[1].." `ساعه` 🔐❌", 'md')
	...
	local arrab = {string.match(text, "^(قفل) (.*)$")}
local keko_info = nil
...
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	 if mutept[2] == "edit"and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التعديل" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم قفل التعديل"..lockwarn.." ", 1, 'md')
 ...
 function keko333(extra,result,success)
  ...
  local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
 if mutept[2] == "bots" or arrab[2] == "البوتات" then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم قفل البوتات"..lockban.." ", 1, 'md')
 ...
 function keko333(extra,result,success)
  ...
  local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
 if mutept[2] == "bots ban" or arrab[2] == "البوتات بالطرد" then
...
keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood ban" and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التكرار بالطرد" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood mute" and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التكرار بالكتم" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
 local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood del" and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التكرار بالمسح" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التثبيت" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or arrab[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media" or arrab[2] == "الوسائط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media warn" or arrab[2] == "الوسائط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media ban" or arrab[2] == "الوسائط بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text" or arrab[2] == "الدردشه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text ban" or arrab[2] == "الدردشه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text warn" or arrab[2] == "الدردشه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline" or arrab[2] == "الانلاين" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline ban" or arrab[2] == "الانلاين بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline warn" or arrab[2] == "الانلاين بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note" or arrab[2] == "بصمه الفيديو" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note ban" or arrab[2] == "بصمه الفيديو بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note warn" or arrab[2] == "بصمه الفيديو بالتحذير" then
...
if mutept[2] == "photo" or arrab[2] == "الصور" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "photo ban" or arrab[2] == "الصور بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "photo warn" or arrab[2] == "الصور بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video" or arrab[2] == "الفيديو" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video ban" or arrab[2] == "الفيديو بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video warn" or arrab[2] == "الفيديو بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif" or arrab[2] == "المتحركه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif ban" or arrab[2] == "المتحركه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif warn" or arrab[2] == "المتحركه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music" or arrab[2] == "الاغاني" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music ban" or arrab[2] == "الاغاني بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music warn" or arrab[2] == "الاغاني بالتحذير" then
...
function keko333(extra,result,success)
 keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   ...
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice" or arrab[2] == "الصوت" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice ban" or arrab[2] == "الصوت بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice warn" or arrab[2] == "الصوت بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "links" or arrab[2] == "الروابط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "links ban" or arrab[2] == "الروابط بالطرد" then
...
if mutept[2] == "links warn" or arrab[2] == "الروابط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location" or arrab[2] == "الشبكات" then
...
local lockban = "\nVخاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location ban" or arrab[2] == "الشبكات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location warn" or arrab[2] == "الشبكات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag" or arrab[2] == "المعرف" then
...
function keko333(extra,result,success)
 keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   ...
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag ban" or arrab[2] == "المعرف بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag warn" or arrab[2] == "المعرف بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag" or arrab[2] == "التاك" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag ban" or arrab[2] == "التاك بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag warn" or arrab[2] == "التاك بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact" or arrab[2] == "الجهات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact ban" or arrab[2] == "الجهات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact warn" or arrab[2] == "الجهات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage" or arrab[2] == "المواقع" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage ban" or arrab[2] == "المواقع بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage warn" or arrab[2] == "المواقع بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic" or arrab[2] == "العربيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic ban" or arrab[2] == "العربيه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic warn" or arrab[2] == "العربيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english" or arrab[2] == "الانكليزيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english ban" or arrab[2] == "الانكليزيه بالطرد" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english warn" or arrab[2] == "الانكليزيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "spam del" or arrab[2] == "الكلايش" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "spam warn" or arrab[2] == "الكلايش بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker" or arrab[2] == "الملصقات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker ban" or arrab[2] == "الملصقات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker warn" or arrab[2] == "الملصقات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file" or arrab[2] == "الملفات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file ban" or arrab[2] == "الملفات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file warn" or arrab[2] == "الملفات بالتحذير" then
...
if mutept[2] == "markdown" or arrab[2] == "الماركدون" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "markdown ban" or arrab[2] == "الماركدون بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "markdown warn" or arrab[2] == "الماركدون بالتحذير" then
...
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  ...
	  if mutept[2] == "service" or arrab[2] == "الاشعارات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd" or arrab[2] == "التوجيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd ban" or arrab[2] == "التوجيه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd warn" or arrab[2] == "التوجيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..keko_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd" or arrab[2] == "الشارحه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..keko_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd ban" or arrab[2] == "الشارحه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..keko_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd warn" or arrab[2] == "الشارحه بالتحذير" then
...
getUser(msg.sender_user_id_, keko333)
	...
	local UNarrab = {string.match(text, "^(فتح) (.*)$")}
	local keko_info = nil
function keko333(extra,result,success)
keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "edit" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التعديل" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
getUser(msg.sender_user_id_, keko333)
 ...
 function keko333(extra,result,success)
  keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "bots" or UNarrab[2] == "البوتات" then
...
function keko333(extra,result,success)
 keko_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   local lockban = "\n🚫┇خاصية ~⪼ طرد البوت والعضو"
   local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "bots ban" or UNarrab[2] == "البوتات بالطرد" then
...
local keko_info = nil
 ...
 local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood ban" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التكرار بالطرد" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood all" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التكرار" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم فتح التكرار"..lockmute.." ", 1, 'md')
 ...
 local keko_info = nil
  ...
  local lockban = "\n🚫┇خاصية ~⪼ الطرد"
 local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood mute" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التكرار بالكتم" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '_> *Flood mute* has been *unlocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood del" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التكرار بالمسح" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:del'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '_> *Flood del* has been *unlocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التثبيت" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
 local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNarrab[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media" or UNarrab[2] == "الوسائط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media warn" or UNarrab[2] == "الوسائط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media ban" or UNarrab[2] == "الوسائط بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text" or UNarrab[2] == "الدردشه" then
	  if database:get('bot:text:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text ban" or UNarrab[2] == "الدردشه بالطرد" then
	  if database:get('bot:text:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text warn" or UNarrab[2] == "الدردشه بالتحذير" then
	  if database:get('bot:text:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note" or UNarrab[2] == "بصمه الفيديو" then
	  if database:get('bot:note:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note ban" or UNarrab[2] == "بصمه الفيديو بالطرد" then
	  if database:get('bot:note:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note warn" or UNarrab[2] == "بصمه الفيديو بالتحذير" then
	  if database:get('bot:note:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video note ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline" or UNarrab[2] == "الانلاين" then
	  if database:get('bot:inline:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline ban" or UNarrab[2] == "الانلاين بالطرد" then
	  if database:get('bot:inline:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline warn" or UNarrab[2] == "الانلاين بالتحذير" then
	  if database:get('bot:inline:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> inline ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo" or UNarrab[2] == "الصور" then
	  if database:get('bot:photo:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo ban" or UNarrab[2] == "الصور بالطرد" then
	  if database:get('bot:photo:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo warn" or UNarrab[2] == "الصور بالتحذير" then
	  if database:get('bot:photo:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> photo ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video" or UNarrab[2] == "الفيديو" then
	  if database:get('bot:video:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video ban" or UNarrab[2] == "الفيديو بالطرد" then
	  if database:get('bot:video:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video warn" or UNarrab[2] == "الفيديو بالتحذير" then
	  if database:get('bot:video:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif" or UNarrab[2] == "المتحركه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif ban" or UNarrab[2] == "المتحركه بالطرد" then
	  if database:get('bot:gifs:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif warn" or UNarrab[2] == "المتحركه بالتحذير" then
	  if database:get('bot:gifs:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> gifs ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = " \n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music" or UNarrab[2] == "الاغاني" then
	  if database:get('bot:music:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music ban" or UNarrab[2] == "الاغاني بالطرد" then
	  if database:get('bot:music:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music warn" or UNarrab[2] == "الاغاني بالتحذير" then
	  if database:get('bot:music:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> music ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice" or UNarrab[2] == "الصوت" then
	  if database:get('bot:voice:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice ban" or UNarrab[2] == "الصوت بالطرد" then
	  if database:get('bot:voice:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice warn" or UNarrab[2] == "الصوت بالتحذير" then
	  if database:get('bot:voice:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links" or UNarrab[2] == "الروابط" then
	  if database:get('bot:links:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links ban" or UNarrab[2] == "الروابط بالطرد" then
	  if database:get('bot:links:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links warn" or UNarrab[2] == "الروابط بالتحذير" then
	  if database:get('bot:links:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> links ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location" or UNarrab[2] == "الشبكات" then
	  if database:get('bot:location:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location ban" or UNarrab[2] == "الشبكات بالطرد" then
	  if database:get('bot:location:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location warn" or UNarrab[2] == "الشبكات بالتحذير" then
	  if database:get('bot:location:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> location ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag" or UNarrab[2] == "المعرف" then
	  if database:get('bot:tag:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag ban" or UNarrab[2] == "المعرف بالطرد" then
	  if database:get('bot:tag:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag warn" or UNarrab[2] == "المعرف بالتحذير" then
	  if database:get('bot:tag:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> tag ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag" or UNarrab[2] == "التاك" then
	  if database:get('bot:hashtag:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag ban" or UNarrab[2] == "التاك بالطرد" then
	  if database:get('bot:hashtag:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag warn" or UNarrab[2] == "التاك بالتحذير" then
	  if database:get('bot:hashtag:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> hashtag ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact" or UNarrab[2] == "الجهات" then
	  if database:get('bot:contact:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact ban" or UNarrab[2] == "الجهات بالطرد" then
	  if database:get('bot:contact:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact warn" or UNarrab[2] == "الجهات بالتحذير" then
	  if database:get('bot:contact:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> contact ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage" or UNarrab[2] == "المواقع" then
	  if database:get('bot:webpage:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage ban" or UNarrab[2] == "المواقع بالطرد" then
	  if database:get('bot:webpage:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage warn" or UNarrab[2] == "المواقع بالتحذير" then
	  if database:get('bot:webpage:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> webpage ban has been_ *unLocked*', 1, 'md')
else
...
local lockmute = "\n🗑┇خاصية ~⪼ المسح"
  local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic" or UNarrab[2] == "العربيه" then
	  if database:get('bot:arabic:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic ban" or UNarrab[2] == "العربيه بالطرد" then
	  if database:get('bot:arabic:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic warn" or UNarrab[2] == "العربيه بالتحذير" then
	  if database:get('bot:arabic:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> arabic ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english" or UNarrab[2] == "الانكليزيه" then
	  if database:get('bot:english:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english ban" or UNarrab[2] == "الانكليزيه بالطرد" then
	  if database:get('bot:english:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english warn" or UNarrab[2] == "الانكليزيه بالتحذير" then
	  if database:get('bot:english:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "spam del" or UNarrab[2] == "الكلايش" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "spam warn" or UNarrab[2] == "الكلايش بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker" or UNarrab[2] == "الملصقات" then
	  if database:get('bot:sticker:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker ban" or UNarrab[2] == "الملصقات بالطرد" then
	  if database:get('bot:sticker:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker warn" or UNarrab[2] == "الملصقات بالتحذير" then
	  if database:get('bot:sticker:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> sticker ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file" or UNarrab[2] == "الملفات" then
	  if database:get('bot:document:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file ban" or UNarrab[2] == "الملفات بالطرد" then
	  if database:get('bot:document:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file warn" or UNarrab[2] == "الملفات بالتحذير" then
	  if database:get('bot:document:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> file ban has been_ *unLocked*', 1, 'md')
else
...
if unmutept[2] == "markdown" or UNarrab[2] == "الماركدون" then
	  if database:get('bot:markdown:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "markdown ban" or UNarrab[2] == "الماركدون بالطرد" then
	  if database:get('bot:markdown:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "markdown warn" or UNarrab[2] == "الماركدون بالتحذير" then
	  if database:get('bot:markdown:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *unLocked*', 1, 'md')
else
...
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  ...
	  if unmutept[2] == "service" or UNarrab[2] == "الاشعارات" then
	  if database:get('bot:tgservice:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd" or UNarrab[2] == "التوجيه" then
	  if database:get('bot:forward:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd ban" or UNarrab[2] == "التوجيه بالطرد" then
	  if database:get('bot:forward:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd warn" or UNarrab[2] == "التوجيه بالتحذير" then
	  if database:get('bot:forward:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> forward ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd" or UNarrab[2] == "الشارحه" then
	  if database:get('bot:cmd:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd ban" or UNarrab[2] == "الشارحه بالطرد" then
	  if database:get('bot:cmd:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..keko_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd warn" or UNarrab[2] == "الشارحه بالتحذير" then
	  if database:get('bot:cmd:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> cmd ban has been_ *unLocked*', 1, 'md')
else
...
os.execute('wget https://raw.githubusercontent.com/moodlIMyIl/arrabapi/master/arrab.lua')
 return false end
...
local nakeko = redis:get('nakeko'..bot_id)
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647707641864), (nakeko or "arrab TEAM"), "", bot_id)
end
 end
  for k,v in pairs(sudo_users) do
...
local keko222 = 'https://arrab.tk/arrabApi/ch.php?id='..msg.sender_user_id_..''
...
🌐┇<strong> ARRAB_H1 </strong>

◀┇<a href="https://telegram.me/ARRAB_H1">مطور السورس، 🦁" </a>
◀┇<a href="https://telegram.me/ARRAB_H1">مطور شروحات سورس، 🦁" </a>

🔎┇<a href="https://github.com/alarrab2/arrab">رابط Github Api (التوكن)،⚜️ </a>
