...
• لتنصيب سورس العراب ع تيجي الجديد ع التوكن 

ֆ • • • • • • • • • • • • • ֆ

• افتح ترمنال وحط 

git clone https://github.com/alarrab2/arrab
...
git clone https://github.com/alarrab2/arrab && cd arrab && chmod +x install.sh && ./install.sh
